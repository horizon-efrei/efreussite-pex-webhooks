...
const imagesBaseUrl = `https://raw.githubusercontent.com/horizon-efrei/efreussite-pex-webhooks/${currentBranch}/resources/_images`;
...
const folderToWebhook = {
  ...
  bachelor: process.env.WEBHOOKURL_BACHELOR,
  master: process.env.WEBHOOKURL_MASTER,
